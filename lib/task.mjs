...
export function parseTask(text) {
  ...
  return {
    ...
    credential: credential
      ...
      : null,
    extensions: raw.extensions == null ? null : raw.extensions,
...
export function validateTask(task, options = {}) {
  ...
  if (task?.extensions != null && !object(task.extensions)) {
...
export function serializeTask(task) {
  ...
  if (task.extensions && object(task.extensions)) value.extensions = task.extensions;
