...
export function canonicalPayload(fields) {
  const ordered = {
    ...
    ...(fields.delivery_intent_digest
      ? { delivery_intent_digest: fields.delivery_intent_digest }
      : {}),
...
export function buildProofFields({
  ...
  return {
    ...
    ...(deliveryIntentDigest ? { delivery_intent_digest: deliveryIntentDigest } : {}),
...
export function verifyProof(proof, publicKey) {
  ...
  const fields = {
    ...
    ...(rest.delivery_intent_digest
      ? { delivery_intent_digest: rest.delivery_intent_digest }
      : {}),
  ...
  if (fields.delivery_intent_digest) {
    const deliveryIntentErr = hashDigestError(
      fields.delivery_intent_digest,
      'delivery_intent_digest',
    );
    if (deliveryIntentErr) return { ok: false, reason: deliveryIntentErr };
  }
